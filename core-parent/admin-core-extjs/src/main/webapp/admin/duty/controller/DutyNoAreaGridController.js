 ...
 * @version 1.0.0
 */
Ext.define('kalix.admin.duty.controller.DutyNoAreaGridController', {
    ...
    onAdd: function () {
        ...
        var addFormPanel = Ext.create('kalix.admin.duty.view.DutyNoAreaAddForm');
    ...
    onEdit: function (grid, rowIndex, colIndex) {
        ...
        var editFormPanel = Ext.create('kalix.admin.duty.view.DutyNoAreaEditForm');
        var model=Ext.create('Ext.data.Model');
