 ...
 * @version 1.0.0
 */
public class OrganizationBeanDaoImpl extends BaseAdminDao<OrganizationBean, String> implements IOrganizationBeanDao {
    private final String className = OrganizationBean.class.getName();

    @Override
    @SuppressWarnings("unchecked")
    public List<OrganizationBean> findByName(String id, String name) {
    ...
    @Override
    @SuppressWarnings("unchecked")
    public List<OrganizationBean> findByCode(String id, String code) {
