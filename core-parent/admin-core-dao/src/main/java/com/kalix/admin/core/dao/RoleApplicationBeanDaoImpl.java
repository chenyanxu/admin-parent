 ...
 * @version 1.0.0
 */
public class RoleApplicationBeanDaoImpl extends BaseAdminDao<RoleApplicationBean, String> implements IRoleApplicationBeanDao {
    ...
    @Override
    public List<RoleApplicationBean> getRoleApplicationsByRoleId(String id) {
