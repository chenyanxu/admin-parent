...
public class FSM implements java.io.Serializable {
     ...
     * @throws IOException
     */
    public FSM(String configFName, String startState, FSMAction action)
            throws ParserConfigurationException, SAXException, IOException {
        this._fsm = new FSMStateList(configFName, startState, !"".equals(configFName));
        this._action = action;
    }
     ...
     * @throws IOException
     */
    public FSM(String configFName, String startState, FSMAction action, Object sharedData)
            throws ParserConfigurationException, SAXException, IOException {
        this(configFName, startState, action);
     ...
     * @throws IOException
     */
    public FSM(InputStream configFStream, String startState, FSMAction action, Object sharedData)
            throws ParserConfigurationException, SAXException, IOException {
        this._fsm = new FSMStateList(configFStream, startState);
        this._action = action;
        this._sharedData = sharedData;
    }
     ...
     * @throws IOException
     */
    public FSM(InputStream configFStream, String startState, FSMAction action)
            throws ParserConfigurationException, SAXException, IOException {
        this(configFStream, startState, action, null);
    }
     ...
     */
    public void setDefaultFsmAction(FSMAction act) {
        _action = act;
    }
